  ...
  return (
    <div dir="rtl" className="min-h-screen bg-[#FCFCFD] text-slate-900 selection:bg-[#EDE8FB] selection:text-[#5B2DC1] overflow-x-clip" style={{ fontFamily: "'Polin', system-ui, -apple-system, sans-serif" }}>
      ...
      <main className="relative w-full">
            ...
            <div className="grid lg:grid-cols-12 gap-16 items-center h-full">
              ...
              <div className="lg:col-span-7">
                ...
                <p className="text-xl lg:text-2xl text-slate-500 mb-10 leading-relaxed max-w-2xl font-light">
                  עוזרת AI חכמה שמבקרת תהליכים, מגלה רווחים אבודים, מניעה צוותים ומייצרת התייעלות בזמן אמת.
                </p>
              ...
              <div className="lg:col-span-5 relative">
                ...
                {/* Alert Widget */}
                <div className="absolute -left-8 top-2 p-5 rounded-2xl bg-white/95 backdrop-blur-md shadow-[0_20px_50px_rgba(0,0,0,0.12)] ring-1 ring-slate-200/60 max-w-[260px] z-20">
        ...
        <section id="problem" className="relative overflow-hidden rounded-t-3xl" style={{position:'sticky', top:0, height:'100vh', zIndex:20}}>
          <RippleBackground className="bg-gradient-to-b from-[#F8F6FE] via-white to-[#F8F8F9]">
          <div className="h-full flex flex-col justify-center gap-14 py-10 relative">
...
{/* ROI Stats Section */}
        <section className="rounded-t-3xl relative" style={{position:'sticky', top:0, height:'100vh', zIndex:30, overflow:'hidden'}}>
          ...
          <div className="max-w-[88rem] mx-auto px-6 lg:px-8 h-full flex flex-col justify-center relative z-10">
            ...
            <div className="relative group overflow-hidden mb-10 rounded-[2rem] bg-white/50 backdrop-blur-[2px] py-4 -mx-6 lg:-mx-8" dir="ltr" style={{maskImage: 'linear-gradient(to right, transparent, black 6%, black 94%, transparent)', WebkitMaskImage: 'linear-gradient(to right, transparent, black 6%, black 94%, transparent)'}}>
              <div className="flex animate-marquee-rtl items-center" style={{width: 'max-content'}}>
                {[1, 2].map(set => (
                  <div key={set} className="flex gap-20 shrink-0 items-center py-4 px-12" aria-hidden={set === 2}>
                    {[
        ...
        {/* How It Works — single unified card */}
        <div id="how-it-works" className="sticky top-0 h-screen overflow-hidden rounded-t-3xl" style={{position:'sticky', zIndex: 50}}>
          <div className="absolute inset-0 z-0" style={{background: 'radial-gradient(125% 125% at 50% 10%, #fff 40%, #9780ED 100%)'}}></div>
          <div className="max-w-[88rem] mx-auto px-6 lg:px-8 h-full flex flex-col justify-center gap-12 relative z-10">

            {/* Title — centered */}
            <div className="text-center">
              <h2 className="text-4xl lg:text-5xl font-semibold mb-4 text-slate-900 tracking-tight">איך טינקרבל עובדת?</h2>
              <p className="text-xl text-slate-500 font-light leading-relaxed">ללא התקנות מורכבות. המערכת מתחברת מאחורי הקלעים ומתחילה לעבוד — <span className="font-semibold text-slate-600">תוך שעות, לא שבועות</span></p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              {/* Card 1 — API */}
              <div className="rounded-[2rem] bg-white/70 backdrop-blur-xl ring-1 ring-white/40 shadow-[0_8px_40px_rgba(91,45,193,0.08)] p-8 flex flex-col gap-5 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                <div className="w-14 h-14 rounded-xl bg-[#F8F6FE] ring-1 ring-[#9780ED]/20 flex items-center justify-center text-xl font-bold text-[#5B2DC1] shrink-0">01</div>
                <div>
                  <p className="text-2xl font-semibold text-slate-900 leading-snug mb-2">התממשקות API</p>
                  <p className="text-base text-slate-500 font-light leading-relaxed">חיבור שקוף וישיר למערכת ה-PMS שלכם — <span className="font-semibold text-slate-700">אופטימה של פריוריטי</span> ו-<span className="font-semibold text-slate-700">Oracle OPERA Cloud</span>. תהליך של מספר דקות ולא משבית את המלון לרגע.</p>
                </div>
              </div>

              {/* Card 2 — Customization */}
              <div className="rounded-[2rem] bg-white/70 backdrop-blur-xl ring-1 ring-white/40 shadow-[0_8px_40px_rgba(91,45,193,0.08)] p-8 flex flex-col gap-5 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                <div className="w-14 h-14 rounded-xl bg-[#F8F6FE] ring-1 ring-[#9780ED]/20 flex items-center justify-center text-xl font-bold text-[#5B2DC1] shrink-0">02</div>
                <div>
                  <p className="text-2xl font-semibold text-slate-900 leading-snug mb-2">התאמה אישית וסקלאביליות</p>
                  <p className="text-base text-slate-500 font-light leading-relaxed">סשן קצרצר לבחירת ההתרעות הקריטיות מתוך מאגר של למעלה מ-50 תרחישים עסקיים שונים. תשתית מתקדמת שצומחת עם הרשת שלכם.</p>
                </div>
              </div>

              {/* Card 3 — Security */}
              <div className="rounded-[2rem] bg-white/70 backdrop-blur-xl ring-1 ring-white/40 shadow-[0_8px_40px_rgba(91,45,193,0.08)] p-8 flex flex-col gap-5 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                <div className="w-14 h-14 rounded-xl bg-[#F8F6FE] ring-1 ring-[#9780ED]/20 flex items-center justify-center text-xl font-bold text-[#5B2DC1] shrink-0">03</div>
                <div className="flex-1">
                  <p className="text-2xl font-semibold text-slate-900 leading-snug mb-2">אבטחת מידע ברמה ארגונית</p>
                  <p className="text-base text-slate-500 font-light leading-relaxed mb-5">עמידה בתקנים המחמירים ביותר בתעשייה, כולל הסמכות בינלאומיות מוכרות.</p>
                  <div className="flex items-center gap-5">
                    <img src="/iso27001.png" alt="ISO 27001:2022" className="h-28 w-auto object-contain" />
                    <img src="/iso27701-badge.png" alt="ISO 27701:2019" className="h-32 w-auto object-contain" style={{filter: 'brightness(0) saturate(100%) invert(16%) sepia(90%) saturate(1200%) hue-rotate(196deg) brightness(95%) contrast(105%)'}} />
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-col animate-chat-vertical">
                  {[1, 2].map(set => (
                    <div key={set} className="flex flex-col gap-4 p-4" aria-hidden={set === 2}>
                      ...
                      {[
                        { icon: Activity, title: 'מנתחת נתוני Revenue Leakage בזמן אמת', desc: 'זיהוי אוטומטי של הפסדים פיננסיים תוך כדי תנועה — לפני שהם הופכים לבעיה.', highlight: true },
                        ...
                        <div key={`card-${i}`} className="rounded-2xl bg-white/80 ring-1 ring-slate-100 p-5 flex items-start gap-5 shrink-0 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
              ...
              <div className="w-full bg-white rounded-[2rem] lg:rounded-[3rem] p-4 lg:p-6 ring-1 ring-slate-900/5 shadow-[0_15px_40px_rgba(0,0,0,0.06)] rotate-[-1deg] hover:rotate-0 transition-all hover:shadow-[0_20px_50px_rgba(0,0,0,0.08)]">
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                  <div className="relative h-[330px] lg:h-[510px] w-full rounded-[1.5rem] lg:rounded-[2.5rem] overflow-hidden bg-slate-200 group">
                    <img src="/partners/metaylim.webp" alt="" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000" />
              ...
              <div className="w-full bg-white rounded-[2rem] lg:rounded-[3rem] p-4 lg:p-6 ring-1 ring-slate-900/5 shadow-[0_15px_40px_rgba(0,0,0,0.06)] rotate-[1deg] hover:rotate-0 transition-all hover:shadow-[0_20px_50px_rgba(0,0,0,0.08)]">
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                  ...
                  <div className="relative h-[330px] lg:h-[510px] w-full rounded-[1.5rem] lg:rounded-[2.5rem] overflow-hidden bg-slate-200 group order-1 lg:order-2">
                    <img src="/partners/mamila.jpg" alt="" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000" />
                    <div className="absolute inset-0 bg-gradient-to-t from-slate-900/20 to-transparent"></div>
                    <div className="absolute bottom-6 right-6 bg-white/95 backdrop-blur-md p-4 rounded-2xl shadow-2xl border border-[#F8F6FE] max-w-[180px] group-hover:-translate-y-2 transition-transform duration-500">
          ...
          <div className="h-full flex flex-col justify-center px-6 lg:px-8">
            <div className="max-w-[80%] lg:max-w-[71rem] mx-auto w-full">
              <div className="w-full bg-slate-50 rounded-[2rem] lg:rounded-[3rem] p-4 lg:p-6 ring-1 ring-slate-900/5 shadow-[0_15px_40px_rgba(0,0,0,0.06)] rotate-[-1deg] hover:rotate-0 transition-all hover:shadow-[0_20px_50px_rgba(0,0,0,0.08)]">
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                  <div className="relative h-[330px] lg:h-[510px] w-full rounded-[1.5rem] lg:rounded-[2.5rem] overflow-hidden bg-slate-200 group">
                    <img src="/partners/mezada.jpg" alt="" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000" />
                    <div className="absolute inset-0 bg-gradient-to-t from-slate-900/20 to-transparent"></div>
                    <div className="absolute bottom-6 right-6 bg-white/95 backdrop-blur-md p-4 rounded-2xl shadow-2xl border border-[#F8F6FE] max-w-[180px] group-hover:-translate-y-2 transition-transform duration-500">
          ...
          <div className="relative z-10 min-h-screen flex flex-col px-6 lg:px-8">
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button onClick={() => setShowPopup(true)} className="bg-white text-[#5B2DC1] px-10 py-5 rounded-full text-lg font-semibold hover:scale-105 transition-transform shadow-xl shadow-[#5B2DC1]/20">להתנסות במערכת</button>
              </div>
            </div>
